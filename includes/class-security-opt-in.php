...
class Security_Opt_In {
	...
	public function __construct() {
		...
		$this->plugin_name = 'security-opt-in';
		$this->version = '1.0.0';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Security_Opt_In_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Security_Opt_In_Public( $this->get_plugin_name(), $this->get_version() );
