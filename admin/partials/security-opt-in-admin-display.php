...
<div class="wrap">
    ...
    <form method="post" name="security-opt-in_options" action="options.php">
        ...
        <!-- enable XML-RPC -->
        <fieldset>
            <legend class="screen-reader-text"><span>Enable XML-RPC</span></legend>
            <label for="<?php echo $this->plugin_name; ?>-comments_css_cleanup">
                ...
                <span><?php esc_attr_e('Enable XML-RPC', $this->plugin_name); ?></span>
            </label>
        </fieldset>
